...
<html lang="en">
  ...
  <body class="bg-blue-100 flex flex-col">
    ...
    <div class="content ml-52 p-4">
      <div class="flex">
        <h1 class="text-xl mb-4">Editar datas del perfil</h1>
        <a href="/src/views/views_Masters/DashMasters.php" class="ml-[70%]"
          ><span class="text-blue-700"><?=$_SESSION["user-data"][0]["NOMBRE"]?></span>/Dashboard</a
        >
      </div>
