...
<body class="bg-blue-100 flex flex-col ">
    ...
    <div class=" h-screen w-48 fixed bg-blue-900 pt-20 flex flex-col justify-normal">
        <div class="border-b-2 border-b-blue-700 flex items-center pb-[-50px]">e
    ...
    <div class="content ml-52 p-4">
        <div class="flex justify-between">
            <h1 class="text-xl mb-4 ">Lista de estudiantes</h1>
            <a href="/src/views/views_admin/AdminDash.php"><span class="text-blue-700">Home</span>/Dashboard</a>
        </div>
