            ...
            <div class="h-[90%] w-[50%] bg-blue-200  rounded-lg">
                ...
                <form action="/src/models/Create_Edit/GuardarAlumno.php" method="post" class="flex-col flex items-center">
                    <label class="font-bold ml-5">DNI
                        <input name="dni" type="text" value="<?= ($_SESSION["alumnos"][$id_buscado]["DNI"]) ?>" class="w-64 h-8 m-5">
                    </label>
                    <label class="font-bold ml-5">NOMBRE
                        <input name="nombre" type="text" value="<?= ($_SESSION["alumnos"][$id_buscado]["NOMBRE"]) ?>" class="w-64 h-8 m-5">
                    </label>
                    ...
                    <label class="font-bold ml-5">DIRECCIÓN
                        <input name="dir" type="text" value="<?= ($_SESSION["alumnos"][$id_buscado]["DIRECCION"]); ?>" class="w-64 h-8 m-5">
                    </label>
                    <label class="font-bold ml-5">TELÉFONO
                        <input name="phone" type="text" value="<?= ($_SESSION["alumnos"][$id_buscado]["TELEFONO"]); ?>" class="w-64 h-8 m-5">
                    </label>
                    <label class="font-bold ml-5">FECHA-NAC
                        <input name="fecha" type="date" value=" <?= ($_SESSION["alumnos"][$id_buscado]["NACIMIENTO"]); ?>" class="w-64 h-8 m-5">
                    </label>
