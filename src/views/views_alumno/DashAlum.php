...
<body class="bg-blue-100 flex flex-col">
    ...
    <div class="pt-5">
      ...
      <ul class="list-none pl-5">
        <li class="mb-2 hover:bg-sky-700">
          <a href="/src/views/views_alumno/ClasesAlum.php" class="block text-white"><i class="fa-solid fa-file-lines"></i><span class="m-3">Clases</span>
          </a>
        </li>
        <li class="mb-2 hover:bg-sky-700">
          <a href="/src/views/views_alumno/EditPerfil.php" class="block text-white"><i class="fa-solid fa-laptop"></i><span class="m-1 text-sm">administra tus cuentas</span>
          </a>
        </li>
      </ul>
    </div>
  ...
  <div class="content ml-52 p-4">
    <div class="flex">
      ...
      <a href="/src/views/views_alumno/DashAlum.php" class="ml-[80%]"><span class="text-blue-700">Home</span>/Dashboard</a>
    </div>
